...
function BuildViewPoints() {
	vp[0] = new ViewPoints( 180, 70, 90, Math.PI*3/4, 1);
	vp[1] = new ViewPoints( 45, 70, -45, Math.PI*3/2, 2);
	vp[2] = new ViewPoints( -65, 70, 60, Math.PI*5/4, 3);
	vp[3] = new ViewPoints( -200, 70, -90, Math.PI*7/4, 4);
